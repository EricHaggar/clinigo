...
|---------------|-----------------------------------|-------------------------|-------------------------------|-------------------------------------|--------------------|
| Deliverable 1 | UML Diagram                       | Firebase Authentication | Sign up feature               | Sign-in feature                     | Model Creation     |
| Deliverable 2 | Admin manage users functionality  | Circle CI integration   | Error Handling                | Admin manage services functionality | Unit Tests         |
| Deliverable 3 | Updating models and UML           | Manage Profile Services | Service Provider Availability | Unit tests                          | Clinic Information |
| Deliverable 4 | Preparing presentation and report | Rating Clinics          | Clinic Search                 | Updating models and UML             | Booking/Check-in   |
